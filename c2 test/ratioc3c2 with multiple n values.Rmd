...
```{r}
ggplot()+
  #geom_line(data = n3, aes(y=n3, x=s))+
...
```
```{r}
test <- c(3,4,10,20,50,100,200,300,400,500,1000)
ratio <- c(n_3,n_4,n_10,n_20,n_50,n_100,n_200,n_300,n_400,n_500,n_1000)
data <- data.frame()
for (i in 1:length(test)){
  c <- data.frame(f = s, ratio = ratio, n=test[i])
  data <- rbind(data,c)
}
```
