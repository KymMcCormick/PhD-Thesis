...
describe(din_e2$demographics_age)
...
print(ciPlot_e2)       # Plot 1 --> in the first page of PDF
#print(myplot2)     # Plot 2 ---> in the second page of the PDF
dev.off() 

pdf("C:/GitHub projects/PhD-Thesis/c2 test/Output/ciPlot_e2.pdf")
print(ciPlot_e2)       # Plot 1 --> in the first page of PDF
#print(myplot2)     # Plot 2 ---> in the second page of the PDF
dev.off() 
```
...
pdf("C:/GitHub projects/PhD-Thesis/c2 test/Output/ciChoosePlot_e2.pdf")
print(ciChoosePlot_e2)       # Plot 1 --> in the first page of PDF
dev.off() 
