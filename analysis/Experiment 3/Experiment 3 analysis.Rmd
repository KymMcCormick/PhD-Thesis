...
Rank_dat <- din  %>%
  ...
  matplot(t(Rank_dat[,2:9]), type = "b", bty="l", pch=c(19,17), ylab = "Proportion Correct", xlab = "Rank position")
  legend("topright", legend = c("Strong memory","Weak memory"),pch =c(19,17), col = c("black","red"), inset = .05)
  box("plot")
```
...
Rank_cum
matplot(t(Rank_cum[,2:9]), type = "b", bty="l", pch=c(19,17), ylab = "Proportion Correct", xlab = "Rank position")
  legend("topright", legend = c("Strong memory","Weak memory"),pch =c(19,17), col = c("black","red"), inset = .05)
  box("plot")
```
