...
obsData <- as.matrix(cbind(obsData,cZero[,1]))
obsData
#obsData
```
...
pred.data <- genpred(out$par, obsData, n)
chisq.modelfit
c.modelfit
d.modelfit
s.modelfit
...
pred.data <- genpred(out$par, obsData_S, n)
chisq.modelfit
c.modelfit
d.modelfit
s.modelfit
...
pred.data_W <- genpred(out$par, obsData_W, n)
chisq.modelfit
c.modelfit
d.modelfit
s.modelfit
